...
class DSSPlugin(object):
    ...
    def rename_file(self, path, new_name):
        ...
        """
        return self.client._perform_empty("POST", "/plugins/%s/contents-actions/rename" % self.plugin_id, body={"oldPath": path, "newName": new_name})
    ...
    def move_file(self, path, new_path):
        ...
        """
        return self.client._perform_empty("POST", "/plugins/%s/contents-actions/move" % self.plugin_id, body={"oldPath": path, "newPath": new_path})
